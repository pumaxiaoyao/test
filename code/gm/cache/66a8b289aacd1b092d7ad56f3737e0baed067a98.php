<div class="tab-pane" id="tab_3">
    <form action="/player/fundList" id="s_search" class="form-inline" style="text-align:right; margin-bottom: 10px;">
        ...
        <div class="form-group">
            <input type="text" name="box_StartTime" id="box_StartTime" value="<?php echo $startTime; ?>" class="form-control input-inline input-small input-sm datepicker"
                placeholder="开始时间">
        </div>
        <div class="form-group">
            <input type="text" name="box_EndTime" id="box_EndTime" value="<?php echo $endTime; ?>" class="form-control input-inline input-small input-sm datepicker"
                placeholder="结束时间">
        </div>
        <div class="form-group">
            <button type="button" id="box_ffs" uid="<?php echo e($account); ?>" class="btn btn-sm green table-group-action-submit">
