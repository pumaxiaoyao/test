        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <form action="/player/fundFlowAjax" id="s_search" class="form-inline" style="text-align:right;">
                    ...
                    placeholder="开始时间" value="<?php echo e($startTime); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select class="table-group-action-input form-control input-inline  input-sm" tabindex="1" id="s_gpid" name="s_gpid">
                                ...
                                <?php $__currentLoopData = $platforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
