                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="portlet_tab1">
                                <form action="/playerfund/dptVerifyAjax" id="s_search1" class="form-inline" style="text-align:right;">
                                    ...
                                    <div class="form-group">
                                    <input type="text" name="s_StartTime" readonly id="s_StartTime" value="<?php echo e($startTime); ?>" class="form-control input-inline input-small input-sm datepicker"
                                            placeholder="开始时间">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="s_EndTime" readonly id="s_EndTime" value="<?php echo e($endTime); ?>" class="form-control input-inline input-small input-sm datepicker"
                                            placeholder="结束时间">
                                    </div>
                                    <div class="form-group">
