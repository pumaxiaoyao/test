<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner">
        ...
        <div class="top-menu">
            <label style="color:green;margin-top: 15px;">当前可用游戏平台额度：<?php echo e(isset($PlatformBalance) ? $PlatformBalance : ""); ?>&nbsp;<a href="/report/trans"><i class="fa fa-search"></i></a></label>&nbsp;&nbsp;
            <ul class="nav navbar-nav pull-right">
                <li class="dropdown dropdown-extended dropdown-notification">
                    ...
                    <ul class="dropdown-menu" id="sysMessageList">
                        <?php $__currentLoopData = $sysMessageList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sysMessage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </li>
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    ...
                    <ul class="dropdown-menu">
                        <li class="external">
                            <h3><span class="bold" id="tasksNum2"><?php echo e(isset($taskCount) ? $taskCount : 0); ?></span>个任务通知</h3>
                        </li>
                        <li>
                ...
                <li class="dropdown dropdown-user">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle" src="/static/incloud/admin/layout/img/avatar3_small.jpg"/>
								...
								<?php echo e(isset($GmName) ? $GmName : ""); ?> </span>
