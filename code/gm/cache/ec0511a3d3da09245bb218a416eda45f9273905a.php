            ...
            <div class="portlet-body">
                ...
                <table class="table table-bordered table-striped table-condensed flip-content table-hover" id="data">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($_type["id"]); ?></td>
                            <td><?php echo e($_type["name"]); ?></td>
                            <td><?php echo e($_type["desc"]); ?></td>
                            <td><?php echo e($_type["created_at"]); ?></td>
                            <td>
                                <?php if($_type["status"] == "1"): ?>
                                <span class="label label-success">启用</span> <?php else: ?>
                                <span class="label label-warning">禁用</span> <?php endif; ?>
                            </td>
                            <td>
                                <a edit="edit" href="javascript:void(0);" status="<?php echo e($_type["status"]); ?>" desc="<?php echo e($_type["desc"]); ?>" cateId="<?php echo e($_type["id"]); ?>" name="<?php echo e($_type["name"]); ?>" class="btn btn-xs green">编辑</a>
                            </td>
                        </tr>
