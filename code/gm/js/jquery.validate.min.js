...
jQuery.validator.addMethod("password", function(value, element) {
    var password = /^(?=.*\d)(?=.*[a-zA-Z]).{8,16}$/;
    return this.optional(element) || (password.test(value));
}, "密码长度为8-16个字符,以及必须含有字母和数字的组合！");

//登录名验证
jQuery.validator.addMethod("username", function(value, element) {
    var username = /^[0-9a-z]{4,12}$/;
    return this.optional(element) || (username.test(value));
}, "用户名由6-14个字符长的字母或数字组合组成！");

//登录名验证
jQuery.validator.addMethod("realname", function(value, element) {
    var realname = /^[0-9a-z_A-Z-.\u4e00-\u9fa5]{2,30}$/;
    return this.optional(element) || (realname.test(value));
}, "真实姓名格式有误！");

jQuery.validator.addMethod("phone", function(value, element) {
    var phone = /^0?(13[0-9]|15[012356789]|18[0123456789]|14[57]|17[012356789])[0-9]{8}$/;
