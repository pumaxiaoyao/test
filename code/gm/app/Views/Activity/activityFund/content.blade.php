            ...
            <div class="portlet-body">
                <form action="/activity/activityFundAjax" id="s_search" class="form-inline" style="text-align:right;">
                    <div class="form-group">
                        <input name="start" id="s_keyword" type="text" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="开始时间"
                            class="table-group-action-input form-control input-inline input-sm" />
                    </div>
                    <div class="form-group">
                        <input name="end" id="s_keyword" type="text" value="" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" placeholder="结束时间"
                            class="table-group-action-input form-control input-inline input-sm" />
                    </div>
                    <div class="form-group">
