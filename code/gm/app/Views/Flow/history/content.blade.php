        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <form action="/flow/getRakeBackHistory" id="s_search" class="form-inline" style="text-align:right;">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ $startTime }}" name="s_StartTime" id="s_StartTime" class="form-control input-inline input-small input-sm datepicker"
                            placeholder="开始时间">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{ $endTime }}" name="s_EndTime" id="s_EndTime" class="form-control input-inline input-small input-sm datepicker"
                            placeholder="结束时间">
                    </div>
                    <div class="form-group">
