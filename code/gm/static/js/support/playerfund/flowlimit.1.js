...
function checkWater(_amount,_gpid,created,uid,_gpname){
	...
	$.get("/kzb/water/player/"+uid+"/"+created,function(data){
...
//通过某条流水条件 或者重启某条流水条件
function endWater(wid,status){
	$.ajax({
	url :"/kzb/fund/changeflows",
	type:'post',
