...
$(document).ready(function () {
    $("#s_search").search({
        '_fnCallback': function (resp) {
            ...
            $("#playerTotal").text(resp.data.iTotalRecords);
        }
    });
});
                        ...
                        success: function (data) {
                            ...
                            if (data.code == 200) {
                                ...
                                if (action == "lock"){
                                    ...
                                    pobj.find("span").text("锁定");
                                    pobj.find("span").removeClass('label-success').addClass('label-danger');
                                    pobj.find("i.fa").removeClass('fa-lock').addClass('fa-unlock');
                                    ...
                                    pobj.find("span").text("正常");
                                    pobj.find("span").removeClass('label-danger').addClass('label-success');
                                    pobj.find("i.fa").removeClass('fa-unlock').addClass('fa-lock');
                                }
                            } else {
