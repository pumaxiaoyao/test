...
jQuery.validator.addMethod("phone", function(value, element) {
    var phone = /^0?(13[0-9]|14[57]|15[0-9]|17[0-9]|18[0-9]|19[9])[0-9]{8}$/;
...
jQuery.validator.addMethod("birth", function(value, element) {
    return $("#yearDropdown option:selected").index() > 0 && $("#monthDropdown option:selected").index() > 0 && $("#dayDropdown option:selected").index() > 0;
}, "出生日期不能为空");
