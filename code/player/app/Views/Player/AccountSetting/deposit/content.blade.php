    ...
    <div class="ck_nr">
        <div class="as_fl20">
            <div class="as_cn">
                ...
                {{--  <div class="as_triangle_down" id="setting_qq_icon">
                    <a onclick="selBankType(this,'qq')" class="as_info">QQ支付</a>
                </div>
                <div class="as_triangle_down" id="setting_alipay_icon">
                    <a id="setting_phone_bt" onclick="selBankType(this,'alipay')" class="as_info">支付宝</a>
                </div>
                <div class="as_triangle_down" id="setting_wechat_icon">
                    <a onclick="selBankType(this,'wechat')" class="as_info">微信支付</a>
                </div>  --}}
