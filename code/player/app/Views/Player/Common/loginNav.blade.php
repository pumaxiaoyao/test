    <div style="position:relative">
        ...
        <a id="head_name_login" href="/player/accountSetting" class="hd_cl hd_cl_right">{{ $LoginMemberName or "" }}</a>
            <span class="hd_cl">
                <a class=" hd_cl_right" href="/player/receivebox">站内信</a>：
            <a class="hd_cl_msgnub_a" href="/player/receivebox"><i>{{ $MessageCount or "" }}</i> </a>
            </span>
    ...
    <div style="color:#fff;" class="hd_cl">中心钱包：<span id="MainBalance_Nav">{{ $MainBalance or "" }}</span></div>
