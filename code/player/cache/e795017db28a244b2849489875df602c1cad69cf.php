    ...
    <div class="tk_nr bank_manage">
        <?php if(!$RealName): ?>
            <div class="withdrawal_bindinfo">
                ...
                <span>请尽快<a href="/player/accountSetting">个人信息</a></span>
            </div>
        <?php elseif(!$Phone): ?>
            <div class="withdrawal_bindinfo">
                <img src="/static/img/player/bigwarn_icon.png" /> <br />
                <span>为了阁下的资金安全，绑定银行卡前，我们需要验证阁下的手机号码。</span><br />
                <span>请尽快<a href="/player/accountSetting?setting=phone">手机号码</a></span>
            </div>
        <?php else: ?>
        ...
        <div class="manage_box_two">
            <ul>
                <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx=> $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li>
                    <i class="<?php echo e($card["sn"]); ?>"></i>
                    <?php echo e($card["name"]); ?> (尾号<?php echo e($card["cardNo"]); ?>)
                    <a onclick="delbank(this, <?php echo e($card["id"]); ?>)">删除</a>
                </li>
            ...
            <div class="binding_info">
                ...
                <div class="bank_info">
                    ...
                    <span>
                            <b>持卡人姓名:</b>
                            <div>
                            <input value="<?php echo e(isset($RealName) ? $RealName : ""); ?>" id="RealName" readonly type="text" class="r_inptut inputwd300" />
                            </div>
                        </span>
                    <span>
                            <b>开户银行:</b>
