...
<?php echo $__env->make('Agent.AccountSetting.withdrawl.scripts', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('Agent.AccountSetting.withdrawl.content', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
