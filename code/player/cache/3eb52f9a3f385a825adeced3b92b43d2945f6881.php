<div class="conmain">
    <div class="nr_nav">
        ...
        <div class="nr_nav_user">
            <div class="nr_nav_user_title"><span id="salutationtext"></span> <b><?php echo e(isset($LoginMemberName) ? $LoginMemberName : ""); ?></b></div>
            <div class="nr_nav_user_time"></div>
            <div class="progress-box">
                <div class="progress">
                    <div class="progress-bar" role="progressbar" data-transitiongoal-backup="0" data-transitiongoal="0" aria-valuenow="0" style="width: <?php echo e(isset($SafetyRate) ? $SafetyRate : "
                        "); ?>%;"></div>
                </div>
            </div>
            <div class="nr_nav_user_help"><span>账户安全等级 <strong><?php echo e(isset($AccountSafetyLevel) ? $AccountSafetyLevel : ""); ?></strong></span>
                <span>
        <b class="pic_1  <?php echo e(empty($Phone)?'':'on'); ?> "><i>提示：为了享受更便捷的手机app服务，请先<a href="/player/accountSetting?setting=phone"> 绑定手机！</a></i></b>
        <b class="pic_2  <?php echo e(empty($Email)?'':'on'); ?> "><i>提示：为了享受更便捷的找回密码服务，请先<a href="/player/accountSetting?setting=mail"> 绑定邮箱！</a></i></b>
        <b class="pic_3  <?php echo e(empty($RealName)?'':'on'); ?> "><i>提示：为了享受更便捷的提款服务，请先<a href="/player/accountSetting"> 绑定真实姓名！</a></i></b>
        <b class="pic_4  <?php echo e(empty($isBindCard)?'':'on'); ?> "> <i>提示：为了享受更便捷的提款服务，请先<a href="/player/BankManager"> 绑定银行卡！</a></i></b>
    </span>
            </div>
        </div>
        <div class="nr_nav_money">
            <div class="nr_nav_money_title"><span>账户余额</span>(中心钱包)</div>
            <div class="nr_nav_money_num"><b id="MainBalance_b"><?php echo e(isset($MainBalance) ? $MainBalance : ""); ?></b><span id="refreshMainBt"></span></div>
        </div>
