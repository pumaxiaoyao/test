<div style="position:relative">
    <span class="mg_lf5_rg_span">
        ...
        <a id="head_name_login" href="/agent/AccountSetting" class="hd_cl hd_cl_right"><?php echo e(isset($LoginMemberName) ? $LoginMemberName : ""); ?></a>
        <span class="hd_cl">
            <a class=" hd_cl_right" href="/agent/receivebox">站内信</a>：
            <a class="hd_cl_msgnub_a" href="/agent/receivebox">
                <i><?php echo e(isset($MessageCount) ? $MessageCount : ""); ?></i>
            </a>
        </span>
    </span>
    <span class="mg_lf5_rg_span">
    ...
    <div style="color:#fff;" class="hd_cl">中心钱包：
        <span id="MainBalance_Nav"><?php echo e(isset($MainBalance) ? $MainBalance : ""); ?></span>
    </div>
