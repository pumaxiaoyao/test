...
<script type="text/javascript">
    var s = 1;
    var partnerCodeArr = [<?php echo $ValidPlatforms; ?>];
    var account = "<?php echo e($LoginMemberName); ?>";
    var _urlbalance = "/kzb/gp/balance?account=<?php echo e($LoginMemberName); ?>&gpid=";
...
<script src="/static/js/player/transfer.js?20171211"></script>
