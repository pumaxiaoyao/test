            ...
            <div id="setting_basicinfo_box" class="setting_box_div" style="text-align: left;  display:block; ">
                ...
                <div class="as_info_xx">
                    ...
                    <div class="as_info_cn1" style=" letter-spacing: 2px; color: #444;">
                        <?php if(!$RealName): ?>
                        <input name="FirstName" type="text" id="FirstName" placeholder="真实姓名" class="r_inptut inputwd300" style="width: 150px" />                        <?php endif; ?>
                        <input name="isFristName" type="hidden" id="isFristName" value="<?php echo e(isset($RealName) ? $RealName : ""); ?>" />
                        <div class="r_inptut " id="memberNamelab" style="display: inline-block;width: auto;"><?php echo e(isset($RealName) ? $RealName : ""); ?></div>
                ...
                <div class="as_info_xx">
                    ...
                    <div class="as_info_cn1" style="line-height:40px; display:inline-block">
                        <?php if(!$RealName): ?>
                        <button id="information_bt" type="button" class="as_but inputwd300"> 保存</button> <?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div id="setting_mail_box" class="setting_box_div">
                ...
                <div class="bindinfo_box" id="isemail_box">
                    <div>
                        ...
                        <span><?php echo e(isset($Email) ? $Email : ""); ?></span>
                    </div>
                ...
                <div id="reemail_box" style="display:none;" class="from_Centered">
                    <div class="setting_pwd_box_row">
                        邮箱地址 ：
                        <input id="setting_mail_box_mailnumber" readonly="readonly" value="<?php echo e(isset($Email) ? $Email : ""); ?>" class="r_inptut inputwd300" type="text"
                        />
                    </div>
                    <div class="setting_pwd_box_row">
                        验证码：
            ...
            <div id="setting_phone_box" class="setting_box_div">
                ...
                <div class="bindinfo_box" id="ismobile_box">
                    <div>
                        ...
                        <span><?php echo e(isset($Phone) ? $Phone : ""); ?></span>
                    </div>
                ...
                <div id="remobile_box" style="display:none;" class="from_Centered">
                    <div class="setting_pwd_box_row">
                        手机号码：
                        <input id="setting_phone_box_phonenumber" value="<?php echo e(isset($Phone) ? $Phone : ""); ?>" readonly="readonly" class="r_inptut inputwd300" type="text"
                        />
                    </div>
                    <div class="setting_pwd_box_row">
                        验证码：
