        ...
        <div style="padding:0px 20px;">
            <div id="setting_basicinfo_box" class="setting_box_div" style="text-align: left;  display:block; ">
                ...
                <div class="as_info_xx">
                    ...
                    <div class="as_info_cn1" style=" letter-spacing: 2px; color: #444;">
                        ...
                        <input name="isFristName" type="hidden" id="isFristName" value="<?php echo e($RealName); ?>" />
                        <div class="r_inptut " id="memberNamelab" style="display: inline-block;width: auto;"><?php echo e($RealName); ?></div>
            ...
            <div id="setting_mail_box" class="setting_box_div">
                ...
                <div id="reemail_box" style="display:none;" class="from_Centered">
                    <div class="setting_pwd_box_row">
                        邮箱地址 ：
                        <input id="setting_mail_box_mailnumber" readonly="readonly" value="<?php echo e($Email); ?>" class="r_inptut inputwd300" type="text"
                        />
                    </div>
                    <div class="setting_pwd_box_row">
                        验证码：
            ...
            <div id="setting_phone_box" class="setting_box_div">
                ...
                <div id="remobile_box" style="display:none;" class="from_Centered">
                    <div class="setting_pwd_box_row">
                        手机号码：
                        <input id="setting_phone_box_phonenumber" value="<?php echo e($Phone); ?>" readonly="readonly" class="r_inptut inputwd300" type="text"
                        />
                    </div>
                    <div class="setting_pwd_box_row">
                        验证码：
