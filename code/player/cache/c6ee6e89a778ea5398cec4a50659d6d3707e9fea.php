                ...
                <div class="hd_main">
                    ...
                    <div class="fl_right">
                        <?php if($LoginStatus == "True"): ?>
                            <?php echo $__env->make('Player.Common.loginNav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>

                        <?php if($LoginStatus == "False"): ?>
                            <?php echo $__env->make('Player.Common.logoutNav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
