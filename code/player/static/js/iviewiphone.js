 ...
 */ (function ($, window, undefined) {
	...
	iView.prototype = {
		...
		startSlider: function () {
            ...
            iv.slider.css('background', 'url("' + iv.defs.image.data('iview:image') + '") no-repeat center  bottom');
